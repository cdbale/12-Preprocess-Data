...
No! One of our error measures was computed on the log-scale. We need to either transform the predictions of our first model using the `log()` function, or transform the predictions of the second model using the `exp()` function.
