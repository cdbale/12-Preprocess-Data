...
- The outcome variable is what we are making
- The explanatory variables are our ingredients
- The recipe defines steps that prepare the ingredients for our model, which produces our outcome
- We'll spend time today learning about different types of pre-processing that might be required
...
tidy(fit_baked, conf.int = TRUE) |> 
  ...
  geom_errorbar(aes(xmin = conf.low, xmax = conf.high), height = .1, orientation = 'y') +
